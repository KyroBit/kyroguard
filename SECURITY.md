...
(a subject seeing another portal's or tenant's data, a policy check passing
...
- portal or tenant-context isolation failures
- policy cache returning another subject's or context's policy map
